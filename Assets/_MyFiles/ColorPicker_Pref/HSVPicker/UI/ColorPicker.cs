...
public class ColorPicker : MonoBehaviour
{
    ...
    private void HSVChanged()
    {
        ...
        gameObj.GetComponent<EmblemEditor>().ChangeColor(color, GetComponentInChildren<HexColorField>().hexInputField.text.ToString());
        gameObj.GetComponent<EmblemEditor>().ColorP();
